        ...
        <div class="col-10 col-md-8 col-xl-4 mx-auto justify-content-center align-items-center">
            <form id="registrationForm" accept-charset="UTF-8">
                <div class="form-row">
					...
					<div class="acc-wrapper mt-3">
                        <label class="" for="userAcc">Тип аккаунта</label><br/>
                        <input class="col-12 form-control data" id="userAcc" type="text" name="userAcc" placeholder="Введите тип аккаунта">
                        <div class="error text-end acc"></div>
                    </div>
...
<script src="http://194.67.116.171/js/admin_registration_creating.js"></script>
</body>
</html>