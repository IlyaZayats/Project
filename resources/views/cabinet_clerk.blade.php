    ...
    <div class="row justify-content-center">
        <div class="col-md-12 mb-5 pb-5">
            <div class="lk_buttons">
                <button type="button" class="lk_but p-3" onclick="location.href='https://www.youtube.com/watch?v=5rnE7V4D7U4'">
                    РАССЫЛКА ПРЕДЛОЖЕНИЙ
                </button><br/>
                <button type="button" class="lk_but p-3" onclick="location.href='http://194.67.116.171/cabinet/messages'">
                    ВХОДЯЩИЕ СООБЩЕНИЯ
                </button><br/>
                <button type="button" class="lk_but p-3" onclick="location.href='https://www.youtube.com/watch?v=5rnE7V4D7U4'">
                    ОБНОВЛЕНИЕ ВИДОВ КРЕДИТОВ
                </button><br/>
                <button type="button" class="lk_but p-3" onclick="location.href='https://www.youtube.com/watch?v=5rnE7V4D7U4'">
                    ЗАНЕСЕНИЕ ИНФОРМАЦИИ О ВЫПЛАТЕ
                </button><br/>
