            ...
            <form id="registrationForm" accept-charset="UTF-8">
                <div class="form-row">
                    ...
                    <div class="name-wrapper mt-3">
                        ...
                        <input class="col-12 form-control data" id="userName" type="text" name="userName" placeholder="Введите ваше имя">
                    ...
                    <div class="password-wrapper mt-3">
                        ...
                        <input class="col-12 mt-1 form-control data" id="userPasswordCheck" type="password" placeholder="Подтвердите ваш пароль">
...
<script src="http://194.67.116.171/js/registration.js"></script>
</body>
</html>